...
fn counters_from_runtime(runtime: &ProjectRuntime) -> RuntimeCountersResponse {
    ...
    RuntimeCountersResponse {
        pipeline: RuntimePipelineCountersResponse {
            ...
            command_queued_total: pipeline.command_queued_total,
            command_queue_full_total: pipeline.command_queue_full_total,
            command_queue_closed_total: pipeline.command_queue_closed_total,
            command_render_failed_total: pipeline.command_render_failed_total,
            command_publish_enqueue_failed_total: pipeline.command_publish_enqueue_failed_total,
            command_published_total: pipeline.command_published_total,
            command_publish_failed_total: pipeline.command_publish_failed_total,
            command_status_update_failed_total: pipeline.command_status_update_failed_total,
        },
